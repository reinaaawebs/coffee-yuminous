	...
	if(isset($_POST['submit'])) {
		...
		if(empty($_POST['first_name']) OR empty($_POST['last_name']) OR empty($_POST['state']) 
		 ...
		 OR empty($_POST['phone']) OR empty($_POST['email'])) {
			...
			$place_order = $conn->prepare("INSERT INTO orders (first_name, last_name, state, street_address, town, zip_code, phone,
			 user_id, status, total_price) VALUES (:first_name, :last_name, :state, :street_address, :town, :zip_code, :phone,
					...
					<div class="form-group">
						...
						<div class="select-wrap">
							...
							<select name="state" id="state" class="form-control">
								...
								<option value="South Korea" style="color: black;">South Korea</option>
								<option value="Hongkong" style="color: black;">Hongkong</option>
