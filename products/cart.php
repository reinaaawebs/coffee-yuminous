					...
					<div class="cart-list">
						...
						<?php else : ?>
							<div class="text-center py-5">
								<h4 class="display-4 text-muted">Your Cart is Empty</h4>
								<p class="lead">Your cart is as empty as your mug! Explore our menu and fill it up with something delicious.</p>
							</div>
						<?php endif; ?>
					</div>
				</div>
    		...
    		<div class="row justify-content-end">
    			<div class="col col-lg-3 col-md-6 mt-5 cart-wrap ftco-animate">
					...
					<form method="POST" action="cart.php">
						...
						<?php if($allCartTotal->total > 0) :?>
						<p class="text-center"><button name="checkout" type="submit" class="btn btn-primary py-3 px-4" style="background-color: black; color: white; border: none;" onmouseover="this.style.backgroundColor='#444'; this.style.cursor='pointer';" onmouseout="this.style.backgroundColor='black'; this.style.cursor='default';">Proceed to Checkout</button></p>
						<?php endif; ?>
					</form>
    			</div>
    		</div>
