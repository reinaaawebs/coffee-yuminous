<?php 
    ...
    session_start();
    define("APPURL", "http://localhost/coffee-yuminous");
    define("IMAGEPRODUCTS", "http://localhost/coffee-yuminous/admin-panel/products-admins/images");
...
<html lang="en">
  ...
  <body>
  	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="<?php echo APPURL; ?>">Coffee<small>Yuminous</small></a>
